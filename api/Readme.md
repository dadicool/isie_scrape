...
* DataSet Name : DATASET = tnac_2011
* Version : VERSION = v1
...
* GET api/DATASET/VERSION/centre/X/Y/Z
  ...
  * Example : GET api/tnac_2011/v1/centre/140/52/001?limit=2

    [{"code":"01","name":"قاعة 1"},{"code":"02","name":null}]

## Bureau
* GET api/DATASET/VERSION/bureau/X/Y/Z/T
  * X : code of a circonscription
  * Y : code of a delegation
  * Z : code of a centre
  * T : code of a bureau
  * Return : JSON representation of the result for bureau T in circonscription X, delegation Y and centre Z
  * Example : GET api/tnac_2011/v1/bureau/140/52/001/01
